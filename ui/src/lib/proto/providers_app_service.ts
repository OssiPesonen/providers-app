...
/**
 * @generated from protobuf message proto.SearchProvider
 */
export interface SearchProvider {
    /**
     * @generated from protobuf field: string searchWords = 1;
     */
    searchWords: string;
}
/**
...
class SearchProvider$Type extends MessageType<SearchProvider> {
    constructor() {
        super("proto.SearchProvider", [
            { no: 1, name: "searchWords", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
    create(value?: PartialMessage<SearchProvider>): SearchProvider {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.searchWords = "";
        if (value !== undefined)
            reflectionMergePartial<SearchProvider>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: SearchProvider): SearchProvider {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string searchWords */ 1:
                    message.searchWords = reader.string();
                    break;
                default:
    ...
    internalBinaryWrite(message: SearchProvider, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string searchWords = 1; */
        if (message.searchWords !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.searchWords);
...
/**
 * @generated MessageType for protobuf message proto.SearchProvider
 */
export const SearchProvider = new SearchProvider$Type();
// @generated message type with reflection information, may provide speed optimized methods
...
export const ProvidersAppService = new ServiceType("proto.ProvidersAppService", [
    ...
    { name: "SearchProviders", options: {}, I: SearchProvider, O: ListOfProviders },
