...
export const removeLocalStorageItem = (key: string) => IS_CLIENT && localStorage.removeItem(key);
...
export const removeSessionStoragItem = (key: string) => IS_CLIENT && sessionStorage.removeItem(key);
